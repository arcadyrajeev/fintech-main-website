...
const workflowSteps = [
  {
    ...
    desc: "Understanding brand perception gaps, product personality, market positioning, visual direction, and how users currently interpret the product.",

    date: "STEP 01",
  },

  {
    title: "Conceptualization & Sketching",

    desc: "Exploring identity concepts, typography direction, visual language, symbolic systems, communication tone, and early creative exploration.",
...

  {
    ...
    desc: "Building cohesive brand systems across identity, color systems, typography, visual hierarchy, communication layers, and digital touchpoints.",
...

  {
    ...
    desc: "Refining consistency, scalability, perception alignment, and visual clarity through feedback, testing, and repeated communication scenarios.",

    date: "STEP 04",
  },
];

export default function BrandWorkflowSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#081125]">
      {/* Glow Top Right */}
      <div className="pointer-events-none absolute top-0 right-0 w-[500px] h-[500px] bg-cyan-500/10 blur-[140px] rounded-full" />

      {/* Glow Bottom Left */}
      <div className="pointer-events-none absolute bottom-0 left-0 w-[400px] h-[400px] bg-violet-500/10 blur-[120px] rounded-full" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-24 py-24 md:py-32">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-neutral-400 text-sm md:text-lg leading-relaxed max-w-2xl">
            Structured around perception clarity, visual consistency, trust
            systems, identity direction, and communication coherence across
