...
const workflowSteps = [
  {
    ...
    desc: "Understanding where onboarding breaks down through hesitation, unclear sequencing, verification fatigue, and operational uncertainty.",

    date: "STEP 01",
  },

  {
    title: "Trust & Flow Mapping",

    desc: "Identifying how users interpret verification requests, permissions, compliance steps, and activation progress across the journey.",

    date: "STEP 02",
  },

  {
    title: "Onboarding System Restructuring",

    desc: "Restructuring onboarding architecture, KYC flows, verification states, and trust communication into a clearer progression system.",
...

  {
    ...
    desc: "Refining onboarding clarity through repeated usage flows, operational edge cases, stakeholder feedback, and activation behavior.",

    date: "STEP 04",
  },
];

export default function OnboardingWorkflowSection() {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-24 py-24 md:py-32">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-neutral-400 text-sm md:text-lg leading-relaxed max-w-2xl">
            Structured around onboarding clarity, verification trust, activation
            flow optimization, and operational confidence across regulated
            product systems.
          </p>
        </div>
